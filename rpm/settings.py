...
ALLOWED_HOSTS = ["strattonhealth.com", "www.strattonhealth.com","localhost","127.0.0.1", "*.ngrok-free.app"]
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@rpm-healthcare.com')
